...
public abstract class BufferExchangeSource<H extends OutputFile.Header> 
	...
	public static final BufferExchangeSource factory(FileSystem rfs, Configuration conf, BufferRequest request) {
    ...
    */
	...
	//jprotected BufferExchangeSource(FileSystem rfs, JobConf conf, BufferRequest request) 
	protected BufferExchangeSource(FileSystem rfs, Configuration conf, BufferRequest request) {
		this.rfs = rfs;
		this.conf = conf;
	...
	private static class FileSource extends BufferExchangeSource<OutputFile.FileHeader> {
		...
		public FileSource(FileSystem rfs, Configuration conf, BufferRequest request) {
	...
	private static class StreamSource extends BufferExchangeSource<OutputFile.StreamHeader> {
		...
		public StreamSource(FileSystem rfs, Configuration conf, BufferRequest request) {
			super(rfs, conf, request);
