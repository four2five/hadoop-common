...
import org.apache.hadoop.mapreduce.v2.app.BufferListener;
...
/**
 * This class is responsible for talking to the Buffer umblical.
...
public class BufferTransferListenerImpl extends CompositeService 
    implements BufferUmbilicalProtocol, BufferListener {

  //private static final JvmTask TASK_FOR_INVALID_JVM = new JvmTask(null, true);

  private static final Log LOG = LogFactory.getLog(BufferTransferListenerImpl.class);
  ...
  public BufferTransferListenerImpl(AppContext context,
      JobTokenSecretManager jobTokenSecretManager) { 
      //RMHeartbeatHandler rmHeartbeatHandler 
    super(BufferTransferListenerImpl.class.getName());
          ...
          new RPC.Builder(conf).setProtocol(BufferUmbilicalProtocol.class)
            ...
            .setPort(0).setNumHandlers(
                //conf.getInt(MRJobConfig.MR_AM_TASK_LISTENER_THREAD_COUNT, 
                 //   MRJobConfig.DEFAULT_MR_AM_TASK_LISTENER_THREAD_COUNT)
                 12) // sort out a configurable for this TODO 
...
//    taskStatus.getIncludeCounters();
  ...
  */
  ...
  public long getProtocolVersion(String arg0, long arg1) throws IOException {
    return BufferUmbilicalProtocol.versionID;
  }
