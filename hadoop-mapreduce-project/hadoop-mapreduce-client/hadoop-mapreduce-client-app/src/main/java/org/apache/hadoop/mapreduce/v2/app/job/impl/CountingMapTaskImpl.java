...
public class CountingMapTaskImpl extends TaskImpl {

  private final TaskSplitMetaInfo taskSplitMetaInfo;
  private static final Log LOG = LogFactory.getLog(CountingMapTaskImpl.class);

  public CountingMapTaskImpl(JobId jobId, int partition, EventHandler eventHandler,
    ...
    LOG.info("Creating a CountingMapTaskImpl"); 
  }
