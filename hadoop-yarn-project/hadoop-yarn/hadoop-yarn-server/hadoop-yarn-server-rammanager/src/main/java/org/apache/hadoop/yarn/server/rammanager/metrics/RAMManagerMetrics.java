 ...
 */
package org.apache.hadoop.yarn.server.rammanager.metrics;
...
@Metrics(about="Metrics for RAM manager", context="yarn")
public class RAMManagerMetrics {
  /*
  ...
  */
  ...
  public static RAMManagerMetrics create() {
    return create(DefaultMetricsSystem.instance());
  }

  static RAMManagerMetrics create(MetricsSystem ms) {
    JvmMetrics.create("RAMManager", null, ms);
    return ms.register(new RAMManagerMetrics());
  }
