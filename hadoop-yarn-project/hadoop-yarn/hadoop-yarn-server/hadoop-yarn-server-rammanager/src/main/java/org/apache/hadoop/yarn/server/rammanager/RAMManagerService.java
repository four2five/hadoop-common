...
public class RAMManagerService extends AbstractService {
  ...
  */
  ...
  protected void serviceInit(Configuration conf) throws Exception {
    LOG.info("RAMManagerService.serviceInit()");
    ThreadFactory tf = new ThreadFactoryBuilder()
      .setNameFormat("RAMManagerService #%d")
      .build();
    if (conf != null) {
  ...
  protected void serviceStop() throws Exception {
    LOG.info("RAMManagerService.serviceStop()");
    /*
    if (sched != null) {
      sched.shutdown();
...
/*
  public static class FileDeletionTask implements Runnable {
    ...
    private final RAMManagerService delService;
    ...
    private FileDeletionTask(RAMManagerService delService, String user,
  ...
  */
   ...
   * {@link RAMManagerService#delete(String, Path, Path...)}
