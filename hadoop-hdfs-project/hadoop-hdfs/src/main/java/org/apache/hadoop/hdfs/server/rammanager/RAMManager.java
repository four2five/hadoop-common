 ...
 */
package org.apache.hadoop.hdfs.server.rammanager;
...
public class RAMManagerNode extends Configured 
  ...
  private static final String USAGE = "Usage: java RAMManagerNode [-rollback | -regular]";
  ...
  // For InterRAMManagerNodeProtocol
  ...
  RAMManagerNode(final Configuration conf) throws IOException {
    this(conf, null);
  }
  ...
  private void startInfoServer(Configuration conf) throws IOException {
    ...
    /*
    this.infoServer = (secureResources == null)  // -jbuck
       ? new HttpServer("rammanagernode", infoHost, tmpInfoPort, tmpInfoPort == 0, 
