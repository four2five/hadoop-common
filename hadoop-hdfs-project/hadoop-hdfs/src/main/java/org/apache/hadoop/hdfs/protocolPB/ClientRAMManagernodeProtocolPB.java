...
@ProtocolInfo(protocolName = 
    "org.apache.hadoop.hdfs.protocol.ClientRAMManagernodeProtocol",
    protocolVersion = 1)
@InterfaceAudience.Private
public interface ClientRAMManagernodeProtocolPB extends
    ClientRAMManagernodeProtocolService.BlockingInterface {
}
