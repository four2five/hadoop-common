...
public class InMemMapTask extends Task {
  /**
  ...
  private static final Log LOG = LogFactory.getLog(InMemMapTask.class.getName());
  ...
  public InMemMapTask(String jobFile, TaskAttemptID taskId, 
 ...
 private <T> T getSplitDetails(Path file, long offset) 
  ...
  public static class MapOutputBuffer<K extends Object, V extends Object>
    ...
    public void init(MapOutputCollector.Context context
      ...
      mapTask = context.getInMemMapTask();
