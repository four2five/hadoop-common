...
public class FileHandle {
  ...
  public Path getOutputFile(TaskAttemptID taskid)
    ...
    return lDirAlloc.getLocalPathToRead(TaskTracker.getIntermediateOutputDir(
                       this.conf.getUser(), jobId.toString(), taskid.toString()) + "/file.out", conf);
  }
  ...
  public Path getOutputFileForWrite(TaskAttemptID taskid, long size)
    ...
    return lDirAlloc.getLocalPathForWrite(TaskTracker.getIntermediateOutputDir(
                       this.conf.getUser(), jobId.toString(), taskid.toString()) + "/file.out", size, conf);
  }
  ...
  public Path getOutputIndexFile(TaskAttemptID taskid)
    throws IOException {
    return lDirAlloc.getLocalPathToRead(TaskTracker.getIntermediateOutputDir(
                       this.conf.getUser(), jobId.toString(), taskid.toString()) + "/file.out.index", conf);
  }
  ...
  public Path getOutputIndexFileForWrite(TaskAttemptID taskid, long size)
    throws IOException {
    return lDirAlloc.getLocalPathForWrite(TaskTracker.getIntermediateOutputDir(
                       this.conf.getUser(), jobId.toString(), taskid.toString()) + "/file.out.index", 
                       size, conf);
  }
  ...
  throws IOException {
    return lDirAlloc.getLocalPathForWrite(TaskTracker.getIntermediateOutputDir(
                       this.conf.getUser(), jobId.toString(), attempt.toString())
  ...
  public Path getInputFile(TaskAttemptID reduceTaskId, TaskID mapTaskId, int id)
    throws IOException {
    return lDirAlloc.getLocalPathToRead(TaskTracker.getIntermediateOutputDir(
                       this.conf.getUser(), jobId.toString(), reduceTaskId.toString())
